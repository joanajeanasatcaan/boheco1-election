<x-ecom-layout>
    <x-slot>
        <div id="deleteOptionContainer" class="hidden items-center gap-4 p-3 mb-4 bg-gradient-to-r from-red-50 to-orange-50 border border">
        </div>
        <div class="p-6">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-8">
                    ...
                    <div class="flex flex-wrap items-center gap-4">
                        ...
                        <button id="refresh-btn"
                            ...
                            <svg id="refresh-icon" class="w-5 h-5 text-gray-600 hover:text-blue-600 transition-colors duration-200" fill="none"
                        ...
                        <tbody id="historyTableBody" class="bg-white divide-y divide-gray-200">
                            <tr class="history-row hover:bg-gray-50 transition-colors duration-150" data-type="voted">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <input type="checkbox" class="history-checkbox rounded border-gray-300 text-blue-600 focus:ring-blue-500 focus:ring-offset-0">
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-2 py-1 text-xs font-semibold rounded-full bg-blue-50 
                            ...
                            <tr class="history-row hover:bg-gray-50 transition-colors duration-150" data-type="verified">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <input type="checkbox" class="history-checkbox rounded border-gray-300 text-blue-600 focus:ring-blue-500 focus:ring-offset-0">
                                </td>
                                <td class="px-6 py-4">
                            ...
                            <tr class="history-row hover:bg-gray-50 transition-colors duration-150" data-type="updated">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <input type="checkbox" class="history-checkbox rounded border-gray-300 text-blue-600 focus:ring-blue-500 focus:ring-offset-0">
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-2 py-1 text-xs font-semibold rounded-full bg-orange-50 text-orange-700 border border-orange-200">
                                        Profile Updates
                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
